...
import { ConsultDeleteService } from '../services'
import { Ctx, EventPattern, Payload, RmqContext } from '@nestjs/microservices'
import { BaseController } from '../../common/bases/base.controller'
import { RmqChannel } from '../../common/contracts'

@Controller()
export class ConsultDeleteController extends BaseController {
  constructor(private service: ConsultDeleteService) {
    super()
  }

  @EventPattern('consult-delete')
